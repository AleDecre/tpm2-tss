    ...
    TPM2B_IV **ivOut)
{
    ...
    r = Esys_VIRT_RestoreState_Async(esysContext, keyHandle, shandle1, shandle2,
     ...
     */
    do {
        r = Esys_VIRT_RestoreState_Finish(esysContext, outData, ivOut);
    ...
    const TPM2B_IV *ivIn)
{
    ...
    r = Tss2_Sys_VIRT_RestoreState_Prepare(esysContext->sys,
    ...
    TPM2B_IV **ivOut)
{
     ...
     */
    r = Tss2_Sys_VIRT_RestoreState_Complete(esysContext->sys,
