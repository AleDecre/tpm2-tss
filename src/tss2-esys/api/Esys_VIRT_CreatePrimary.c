    ...
    TPMT_TK_CREATION **creationTicket)
{
    ...
    r = Esys_VIRT_CreatePrimary_Async(esysContext, primaryHandle, shandle1, shandle2,
     ...
     */
    do {
        r = Esys_VIRT_CreatePrimary_Finish(esysContext, objectHandle, outPublic,
    ...
    const TPML_PCR_SELECTION *creationPCR)
{
    ...
    r = Tss2_Sys_VIRT_CreatePrimary_Prepare(esysContext->sys,
    ...
    TPMT_TK_CREATION **creationTicket)
{
    ...
    *objectHandle = esysContext->esys_handle_cnt++;
     ...
     */
    r = Tss2_Sys_VIRT_CreatePrimary_Complete(esysContext->sys,
