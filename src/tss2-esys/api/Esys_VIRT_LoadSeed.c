    ...
    const TPM2B_PUBLIC *inPublic, ESYS_TR *objectHandle)
{
    ...
    r = Esys_VIRT_LoadSeed_Async(esysContext, parentHandle, shandle1, shandle2, shandle3,
                        inPrivate, inPublic);
     ...
     */
    do {
        r = Esys_VIRT_LoadSeed_Finish(esysContext, objectHandle);
    ...
    const TPM2B_PUBLIC *inPublic)
{
    ...
    r = Tss2_Sys_VIRT_LoadSeed_Prepare(esysContext->sys,
    ...
    ESYS_CONTEXT *esysContext, ESYS_TR *objectHandle)
{
    ...
    *objectHandle = esysContext->esys_handle_cnt++;
     ...
     */
    r = Tss2_Sys_VIRT_LoadSeed_Complete(esysContext->sys, &objectHandleNode->rsrc.handle,
                               &name);
