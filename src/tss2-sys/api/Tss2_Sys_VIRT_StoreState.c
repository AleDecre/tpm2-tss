    ...
    const TPM2B_IV *ivIn)
{
    ...
    rval = CommonPreparePrologue (ctx, TPM2_CC_VIRT_StoreState);
    if (rval)
        return rval;
    ...
    TSS2L_SYS_AUTH_RESPONSE *rspAuthsArray)
{
    ...
    rval = Tss2_Sys_VIRT_StoreState_Prepare (sysContext,
                                             keyHandle,
                                             inData,
                                             mode,
                                             ivIn);
    ...
    return Tss2_Sys_VIRT_StoreState_Complete (sysContext, outData, ivOut);
}
