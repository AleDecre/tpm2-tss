    ...
    const TPML_PCR_SELECTION *creationPCR)
{
    ...
    rval = CommonPreparePrologue(ctx, TPM2_CC_VIRT_CreatePrimary);
    if (rval)
        return rval;
    ...
    TSS2L_SYS_AUTH_RESPONSE *rspAuthsArray)
{
    ...
    rval = Tss2_Sys_VIRT_CreatePrimary_Prepare(sysContext, primaryHandle, inSensitive,
    ...
    rval = Tss2_Sys_VIRT_CreatePrimary_Complete(sysContext, objectHandle, outPublic,
